...
var Editar_bodegaApp = function (options) {
    var self = this;
    var component = {};
    ...
    //var productosSeleccionadoseditar = [];
    ...
    this.init = function () {
        ...
        $('#EditarOVisualizarBodega').on('click', '.btnGuardarFilaEditar', function () {
        ...
        $('#EditarOVisualizarBodega').on('click', '.btnEditarFilaBodegaEditar', function () {
            const fila = $(this).closest('tr');
        ...
        $('#EditarOVisualizarBodega').on('click', '.btnEliminarFilaBodegaEditar', function () {
            const fila = $(this).closest('tr');
